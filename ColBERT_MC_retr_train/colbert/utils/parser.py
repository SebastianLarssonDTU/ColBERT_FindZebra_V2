...
class Arguments():
    ...
    def add_model_training_parameters(self):
        ...
        self.add_argument('--freeze_layers', dest='freeze_layers', default=False, action='store_true') #Added by me
        self.add_argument('--iteration', dest='iteration', default=0, type=int)
    ...
    def add_mc_input(self): # Added by Sebastian for multiple choice eval
        self.add_argument('--triples', dest='triples', required=True)
        self.add_argument('--multiple_choice', dest='multiple_choice', default=False, action='store_true')
        self.add_argument('--num_options', dest='num_options', default=None, required=False)
        self.add_argument('--resume', dest='resume', default=False, action='store_true')
        self.add_argument('--resume_optimizer', dest='resume_optimizer', default=False, action='store_true')
        self.add_argument('--checkpoint', dest='checkpoint', default=None, required=False)
    ...
    def add_mc_input_training(self): # Added by Sebastian for multiple choice training
        self.add_argument('--multiple_choice', dest='multiple_choice', default=False, action='store_true')
        self.add_argument('--num_options', dest='num_options', default=None, required=False)
